...
class PINN(PINNbase):
    def train(self):
        ...
        j = i
        # Training loop
        for k in tqdm(range(self.c.optimization_init_kwargs["n_steps2"])):
            i = j + k
            keys_next = [next(keys_iter[i]) for i in range(num_keysplit)]
    ...
    def report1(self, i, report_fn, dynamic_params, all_params, p_batch, v_batch, g_batch, ffgrid_batch, ffval_batch, b_batch, valid_data, e_batch_key, save_step, model_fns):
        ...
        if save_report:
            ...
            if v_pred.shape[1] == 5:
                print(f"step_num : {i:<{12}} u_loss : {Losses[1]:<{12}.{5}} v_loss : {Losses[2]:<{12}.{5}} w_loss : {Losses[3]:<{12}.{5}} fu_loss : {Losses[4]:<{12}.{5}} fv_loss : {Losses[5]:<{12}.{5}} fw_loss : {Losses[6]:<{12}.{5}} fp_loss : {Losses[7]:<{12}.{5}} u_error : {u_error:<{12}.{5}} v_error : {v_error:<{12}.{5}} w_error : {w_error:<{12}.{5}} T_error : {T_error:<{12}.{5}}")
                ...
                print(f"step_num : {i:<{12}} u_loss : {Losses[1]:<{12}.{5}} v_loss : {Losses[2]:<{12}.{5}} w_loss : {Losses[3]:<{12}.{5}} fu_loss : {Losses[4]:<{12}.{5}} fv_loss : {Losses[5]:<{12}.{5}} fw_loss : {Losses[6]:<{12}.{5}} fp_loss : {Losses[7]:<{12}.{5}} u_error : {u_error:<{12}.{5}} v_error : {v_error:<{12}.{5}} w_error : {w_error:<{12}.{5}}")
                with open(self.c.report_out_dir + "reports.txt", "a") as f:
    ...
    def report2(self, i, report_fn, dynamic_params, all_params, loss_factor, p_batch, v_batch, g_batch, ffgrid_batch, ffval_batch, b_batch, valid_data, e_batch_key, save_step, model_fns):
        ...
        if save_report:
            ...
            if v_pred.shape[1] == 5:
                print(f"step_num : {i:<{12}} u_loss : {Losses[1]:<{12}.{5}} v_loss : {Losses[2]:<{12}.{5}} w_loss : {Losses[3]:<{12}.{5}} fu_loss : {Losses[4]:<{12}.{5}} fv_loss : {Losses[5]:<{12}.{5}} fw_loss : {Losses[6]:<{12}.{5}} fp_loss : {Losses[7]:<{12}.{5}} con_loss : {Losses[8]:<{12}.{5}} NS1_loss : {Losses[9]:<{12}.{5}} NS2_loss : {Losses[10]:<{12}.{5}} NS3_loss : {Losses[11]:<{12}.{5}} u_error : {u_error:<{12}.{5}} v_error : {v_error:<{12}.{5}} w_error : {w_error:<{12}.{5}} T_error : {T_error:<{12}.{5}}")
                with open(self.c.report_out_dir + "reports.txt", "a") as f:
                ...
                print(f"step_num : {i:<{12}} u_loss : {Losses[1]:<{12}.{5}} v_loss : {Losses[2]:<{12}.{5}} w_loss : {Losses[3]:<{12}.{5}} fu_loss : {Losses[4]:<{12}.{5}} fv_loss : {Losses[5]:<{12}.{5}} fw_loss : {Losses[6]:<{12}.{5}} fp_loss : {Losses[7]:<{12}.{5}} con_loss : {Losses[8]:<{12}.{5}} NS1_loss : {Losses[9]:<{12}.{5}} NS2_loss : {Losses[10]:<{12}.{5}} NS3_loss : {Losses[11]:<{12}.{5}} u_error : {u_error:<{12}.{5}} v_error : {v_error:<{12}.{5}} w_error : {w_error:<{12}.{5}}")
                with open(self.c.report_out_dir + "reports.txt", "a") as f:
